  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      setUser({
        name: '',
        email: '',
        avatar: 'https://png.pngtree.com/png-clipart/20230102/original/pngtree-purple-hair-girl-avatar-png-image_8855191.png', // Assuming the avatar.png is in the public folder
      });
    }, 1000);
  }, []);
